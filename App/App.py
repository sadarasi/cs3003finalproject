...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='12345678',db='cv')
...
def run():
    ...
    img = Image.open('./Logo/resume (2).png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Sainidhi</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built by 
            <a href="https://www.linkedin.com/in/sainidhisadaram/" style="text-decoration: none; color: blue;">Sainidhi Sadaram</a> 
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Sainidhi ! Total %d " % values + " User's Have Used Our Tool : )")                
